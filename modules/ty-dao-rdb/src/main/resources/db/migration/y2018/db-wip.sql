alter table user_stats3 add column tour_tips_states jsonb;
alter table user_stats3 add constraint userstats_c_tourtips_len check (pg_column_size(tour_tips_states) between 2 and 400);
